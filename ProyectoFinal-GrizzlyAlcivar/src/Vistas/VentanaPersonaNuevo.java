//GRIZZLY ALCIVAR
package Vistas;
import Controlador.ControladorPersonaNuevo;
...
public class VentanaPersonaNuevo extends JFrame{
    //VARIBLES 
...
//Segundo Panel - componenetes 
        ...
        SubPanel8.add(btnguaradar,BorderLayout.PAGE_END);
        SubPanel8.add(btnmostrar,BorderLayout.PAGE_END); 
    ...
    public static void main(String[] args) {
        VentanaPersonaNuevo ventana = new VentanaPersonaNuevo();
        ControladorPersonaNuevo controlador = new ControladorPersonaNuevo(ventana);
